...
/// <reference path="api-auth.enums.ts" />
...
declare module StageMe.Auth.Models.Entities {
...
declare module StageMe.Auth.Models.Requests {
	interface CastInviteBase {
		communityId: string;
	}
	interface CastInviteEmail extends StageMe.Auth.Models.Requests.CastInviteBase {
		displayName: string;
		email: string;
	}
	interface CastInviteRedeem extends StageMe.Auth.Models.Requests.CastInviteVerify {
	}
	interface CastInviteVerify {
		castInviteCode: string;
	}
	interface ChangeEmailRedeem extends StageMe.Auth.Models.Requests.ChangeEmailVerify {
	}
	...
	interface ConfirmEmailRedeem extends StageMe.Auth.Models.Requests.ConfirmEmailVerify {
	}
	interface ConfirmEmailVerify {
		confirmationCode: string;
	}
	interface DeregisterRedeem extends StageMe.Auth.Models.Requests.DeregisterVerify {
	}
	interface DeregisterVerify {
		deregisterCode: string;
	}
	interface EmailLogonRegister extends StageMe.Auth.Models.Requests.LogonRegisterBase {
		email: string;
	}
	interface ExternalLogon {
		ExternalAccessToken: string;
		Provider: string;
		UserName: string;
	}
	interface ExternalLogonConnect {
		externalAccessToken: string;
		provider: string;
	}
	interface ExternalLogonDisconnect {
		provider: string;
		providerKey: string;
	}
	interface ExternalLogonRegistration extends StageMe.Auth.Models.Requests.ExternalLogonConnect {
		birthday: string;
		firstName: string;
		lastName: string;
	...
	interface LogonRegisterBase {
		birthday: string;
		challengeSolution: StageMe.Common.Web.Models.Requests.Challenge.ChallengeSolution;
		firstName: string;
		lastName: string;
		password: string;
		referrerBCode: string;
	...
	interface PasswordResetRedeem extends StageMe.Auth.Models.Requests.PasswordResetVerify {
	...
	interface PhoneNoLogonRegister extends StageMe.Auth.Models.Requests.LogonRegisterBase {
		phoneNo: string;
		registerCode: string;
	}
	...
	interface ProposedUserName {
		userName: string;
	}
	interface SuggestUsernameExternal extends StageMe.Auth.Models.Requests.ExternalLogonConnect {
	}
	interface SuggestUsernameInternal {
		email: string;
		friendlyName: string;
	}
...
declare module StageMe.Auth.Models.Responses {
	interface RegisterationOutcome {
		viaAssociation: boolean;
	}
	interface TokenWrapper {
		actionToken: StageMe.Auth.Models.Entities.ActionToken;
		isValid: boolean;
		message: string;
	}
	interface TokenWrapperUser extends StageMe.Auth.Models.Responses.TokenWrapper {
		userInfo: StageMe.Common.Web.Models.Views.User.UserInfo;
	}
}
...
declare module StageMe.Common.Web.Models.Views.Community {
	interface CommunityCastInfo {
		castedDateTime: Date;
		remainingInvites: number;
	}
	interface CommunityMembership {
		castInfo: StageMe.Common.Web.Models.Views.Community.CommunityCastInfo;
		communityId: string;
		communityName: string;
		isCastMember: boolean;
		isCastPerformer: boolean;
		isOther: boolean;
		isUncastPerformer: boolean;
	}
}
...
declare module StageMe.Common.Web.Models.Views.Url {
	interface ProfileLink {
		socialProfileUsernameFacebook: string;
		socialProfileUsernameInstagram: string;
		socialProfileUsernameSnapChat: string;
		socialProfileUsernameSoundCloud: string;
		socialProfileUsernameTumblr: string;
		socialProfileUsernameTwitter: string;
		socialProfileUsernameVimeo: string;
		socialProfileUsernameVine: string;
		socialProfileUsernameYouTube: string;
		websiteUrl: string;
	}
}
...
declare module StageMe.Common.Web.Models.Views.User {
	interface UserInfo {
		bio: string;
		birthday: string;
		color: StageMe.Common.Web.Models.Values.eColor;
		communityMemberships: StageMe.Common.Web.Models.Views.Community.CommunityMembership[];
		country: string;
		firstName: string;
		gender: number;
		images: StageMe.Common.Web.Models.Views.Urls.ImageUrls;
		isCastAnywhere: boolean;
		joinedDateTime: Date;
		lastName: string;
		links: StageMe.Common.Web.Models.Views.Url.ProfileLink;
		location: string;
		performerType: StageMe.Common.Web.Models.Values.ePerformerType;
		promoterType: StageMe.Common.Web.Models.Values.ePromoterType;
		urls: StageMe.Common.Web.Models.Views.Urls.EntityUrls;
		username: string;
	}
